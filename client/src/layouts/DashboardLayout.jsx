        ...
        <div className="flex h-screen" style={{ backgroundColor: 'var(--csd-bg-main)' }}>
            ...
            <div className="fixed top-0 left-0 right-0 z-40 md:hidden flex items-center justify-between px-4 h-14 shadow-sm"
                ...
                <div className="flex items-center gap-2">
                    ...
                    />
                    <span className="font-bold text-base" style={{ color: 'var(--csd-brand-primary)' }}>CampusDesk</span>
                </div>
                <Link to="/dashboard/notifications" className="relative p-2 rounded-lg hover:bg-[var(--csd-bg-subtle)] transition" style={{ color: 'var(--csd-text-primary)' }}>
                    <Bell size={20} />
                    {unreadCount > 0 && (
